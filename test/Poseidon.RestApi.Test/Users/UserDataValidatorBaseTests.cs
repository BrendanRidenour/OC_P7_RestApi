...
{
    public class UserDataValidatorBaseTests
    {
        [Fact]
        public void InheritsAbstractValidator()
        {
            Assert.True(typeof(AbstractValidator<UserData>)
                .IsAssignableFrom(typeof(UserDataValidatorBase<UserData>)));
        }
        ...
        private static TestUserDataValidatorBase CreateValidator() =>
            new TestUserDataValidatorBase();
        ...
        private class TestUserDataValidatorBase : UserDataValidatorBase<UserData> { }
    }
}